...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] transPhotoArray = new int[]{R.drawable.trans1, R.drawable.trans2, R.drawable.trans3, R.drawable.trans4, R.drawable.trans5, R.drawable.trans6};
        ...
        Data[] cubeeDate = new Data[cubeeNameArray.length];
        for(int i = 0; i < cubeeDate.length; i++){
            cubeeDate[i] = new Data();
            cubeeDate[i].name = cubeeNameArray[i];
            cubeeDate[i].photo = cubeePhotoIdArray[i];
        }

        MyAdapter cubeeAdapter = new MyAdapter(cubeeDate, R.layout.cubee_list);
        GridView gridView = findViewById(R.id.gridview);
        gridView.setAdapter(cubeeAdapter);
        gridView.setNumColumns(3);

        String[] messageArray = new String[]{"訊息1", "訊息2", "訊息3"
                , "訊息4", "訊息5", "訊息6"};
